      ...
      <div className="grid grid-cols-5 gap-8 items-center ">
        <div className="col-span-2">
          ...
          <p className="text-left font-normal  p-8  shadow-2xl rounded-md">
            ...
            stronger, more compassionate communities. <br /> From organizing sports
            events that promote physical health and unity to providing critical
            relief during natural disasters, such as floods and the COVID-19
            pandemic, Lamkine Student Council plays a vital role in uplifting
            those in need. We believe in the power of students to make a
            difference and lead the way in creating a brighter future for all.
          </p>
